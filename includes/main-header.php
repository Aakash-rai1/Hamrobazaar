<?php
// Process cart actions if requested
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
                ...
                <div class="logo">
                    <a href="index.php">
                        <h2 style="color: #212121 "><b>Hamro Bazaar</b></h2>
                    </a>
                </div>
            </div>
                    ...
                    <form name="search" method="post" action="search-result.php">
                        <div class="input-group">
                            <input type="text" class="form-control search-field"
                                placeholder="What are you looking for..." name="product" required="required"
                                style="color: black;">
                            <span class="input-group-btn">
                                <button class="btn btn-primary " type="submit"
                                    name="search" style="color: #212121">Search</button>
                            </span>
                        </div><!-- /.input-group -->
                    </form>
                </div><!-- /.search-area -->
                                ...
                                <div class="clearfix cart-total">
                                    <div class="pull-right">
                                        <span class="text">Total :</span><span
                                            class='price'>$<?php echo $_SESSION['tp'] = "$totalprice" . ".00"; ?></span>
                                    </div>
                                    <div class="clearfix"></div>
